...
static inline void rcc_reset(void)
{
    ...
    regval = getreg32(STM32_RCC_CR);
    regval &= ~(RCC_CR_HSEON | RCC_CR_HSI48ON | RCC_CR_CSION | RCC_CR_PLL1ON | RCC_CR_PLL2ON | RCC_CR_PLL3ON | RCC_CR_HSIDIV_MASK);
...
static inline void rcc_enableahb1(void)
{
    ...
    regval |= (RCC_AHB1ENR_ETH1MACEN | RCC_AHB1ENR_ETH1TXEN | RCC_AHB1ENR_ETH1RXEN);
#endif
